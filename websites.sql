...
insert into miembros values(null,'Pbro. Víctor Manuel G.','Presidente','Comisión de la Juventud 
Prelatura de Yauyos','member1.webp');
insert into miembros values(null,'Daniel Ramos Quiroz','Coordinador General','Comisión de la Juventud 
Prelatura de Yauyos','member2.webp');
insert into miembros values(null,'María Luisa Valdivieso','Secretaria','Comisión de la Juventud 
Prelatura de Yauyos','member3.webp');
insert into miembros values(null,'Polet Ramos G.
','','Consejo Comisión de la Juventud','member4.webp');
